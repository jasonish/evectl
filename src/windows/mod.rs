...
mod imp {
    ...
    const EVEBOX_VERSION: &str = "0.24.0";
    const EVEBOX_VERSION_MARKER: &str = ".evectl-evebox-version";
    const EVEBOX_URL: &str =
        "https://evebox.org/files/release/0.24.0/evebox-0.24.0-windows-x64.zip";
    ...
    #[cfg(windows)]
    fn prompt_for_interface() -> Result<WindowsInterface> {
        ...
        for interface in &interfaces {
            ...
            selections.push((interface.clone(), display_name));
        }
        ...
        selections
            ...
            .ok_or_else(|| anyhow!("Failed to find selected interface"))
    }
